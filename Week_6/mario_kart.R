...
ggplot(data = rr, mapping = aes(x = date, y = time)) +
  ...
  geom_text(data = data.frame(x = as.Date("2017-5-05"), y = 110, label = 'Forest64 discovered a\n Lakitu skip that\ninstantly takes you\n back to the very end\n (October 2020)', family = 'Press Start 2P'), 
            aes(x = x, y = y, label = label), size = 3, colour = "white") +
  ...
  theme(
    ...
    plot.title = element_text(colour = '#e70012', family = 'Press Start 2P', size = 45, hjust = 0, margin = margin(t = 10,b=10,r=0,l=0)),
    plot.subtitle = element_text(colour = 'white', family = 'Montserrat', size = 15, hjust = 0, margin = margin(t=10,b=10,l=10,r=10)),
    plot.caption  = element_text(colour = 'white', family = 'Montserrat', size = 10, hjust = 1.12),
    axis.text = element_text(color = "white", size = 11, family = 'Press Start 2P'),
    axis.line = element_line(color = "white"),
    axis.title = element_text(color = "#e70012", size = 20, family = 'Press Start 2P'),
